...
public class QuestionBean implements Serializable {
	...
	public static void main(String[]args)
	{
		...
		QuestionBean serializedObjectofQuestionBean = new QuestionBean();
		
	
//		serializedObjectofQuestionBean.myAsked = true;
//		serializedObjectofQuestionBean.myCorrectAnswer = "Yes";
//		serializedObjectofQuestionBean.myUserAnswer = "Yes";
	
		
		try {
			
			File questionBeanFile = new File("QuestionBean.ser");
			
			FileOutputStream file = new FileOutputStream(questionBeanFile);
			
			ObjectOutputStream out = new ObjectOutputStream(file);
			
			out.writeObject(serializedObjectofQuestionBean);
			
			out.flush();
			
			out.close();
			
			System.out.println("Success Object has been Serialized Successfully");
